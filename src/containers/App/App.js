...
class App extends Component {
  ...
  setWeatherBasedOnCoordinates = async (location) => {
    ...
    const API_URL = 'http://springbootrestweatherapp-env.eba-zqe5eawt.us-east-1.elasticbeanstalk.com/api/coordinates?';
  ...
  setWeatherBasedOnCity = () => {
    ...
    const API_URL = 'http://springbootrestweatherapp-env.eba-zqe5eawt.us-east-1.elasticbeanstalk.com/api';
  ...
  getWeatherFromStation = () => {
    const URL = 'http://springbootrestweatherapp-env.eba-zqe5eawt.us-east-1.elasticbeanstalk.com/thingspeak/data';
    this.setState({
      weatherStationDetails: {},
    }, () => {
      // Executed as callback function
